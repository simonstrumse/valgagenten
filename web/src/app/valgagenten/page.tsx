...
export default function ValgagentenPage() {
  ...
  return (
    <div className="min-h-screen px-6 py-12 max-w-4xl mx-auto">
      ...
      <footer className="mt-16 text-sm text-muted-foreground">
        <Link className="underline" href="/">Tilbake</Link> · {" "}
        <Link className="underline" href="/personvern">Personvern</Link> · {" "}
        <Link className="underline" href="/vilkår">Vilkår</Link>
      </footer>
    </div>
  );
}
